  ...
  return (
    <div className="relative w-screen h-dvh overflow-hidden font-sans select-none">
      ...
      >
        ...
        {/* <div className="absolute inset-0 bg-linear-to-b from-black/80 via-amber-950/30 to-black/40 backdrop-brightness-90"></div> */}
        {/* <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-amber-950/40 to-black/60 backdrop-brightness-75"></div> */}
      ...
      <div className="relative z-10 flex flex-col justify-between h-full">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4">
          <div className="space-y-2 animate-fade-in ">
            <h1 className="mb-10 text-9xl md:text-8xl font-hindi text-amber-400 tracking-wider drop-shadow-[0_5px_15px_rgba(245,158,11,0.4)]">
              बैठक
            </h1>
            
            <p className="text-xl md:text-2xl font-light tracking-[0.3em] uppercase text-amber-200/90 drop-shadow-md">
              <span className="text-amber-500">•</span> Playlist <span className="text-amber-500">•</span>
            </p>
          </div>
        </div>

        {/* Footer / Audio Player Section */}
        <div className="p-6">
            <Tagline />
          <AudioPlayer />
        </div>
